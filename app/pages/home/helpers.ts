...
export const levelDescriptions = [
	"Read Hangul and use essential greetings",
	"Build simple, polite everyday sentences",
	"Talk about routines, plans, and past experiences",
];
...
export function getTodayLabel(guideLanguage: string) {
	return new Intl.DateTimeFormat(guideLanguage === "id" ? "id-ID" : "en-US", {
		weekday: "long",
		month: "long",
		day: "numeric",
	})
