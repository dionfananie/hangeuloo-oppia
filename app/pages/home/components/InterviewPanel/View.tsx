...
function InterviewPanel({ scenarios, recording, setRecording, speak, done }: { scenarios: InterviewScenario[]; recording: boolean; setRecording: (v: boolean) => void; speak: SpeakFn; done: () => void }) {
	const { stage, setStage, scenario, scenarioId, setScenarioId, answer, setAnswer, micNote, audioUrl, speed, setSpeed, transcriptFetcher, feedbackFetcher, startVoice, stopVoice, transcribe, requestFeedback } = useInterviewPanel({ scenarios, recording, setRecording, done });
